...
### Added
- **Mermaid**: New custom parser for Mermaid state diagrams from Markdown files.
- **Integration**: States are accessible as callable placeholder functions.
- **Integration**: Transitions are accessible as objects with source, target, and executable actions.
- **Validation**: Added `mermaid_diagram` type support for Cerberus validation.
- **OSS**: Enhanced project structure and documentation for OSS best practices.
